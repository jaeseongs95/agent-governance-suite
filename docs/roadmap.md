...
문서 기준일은 2026년 9월 18일이다. 현재 공개 릴리스는 `v1.15.0`이다. 한국어 산문 워크플로는 확장한 용어집 검증과 사용자의 명시적 배포 승인에 따라 활성화했고, 2026년 9월 17일 동결 frame `0.3.0-gate-1`(130건, suite revision `9377b6d19eb3a07671dad85af4aaf5e5ce0f5d81`)에서 `EVALUATION_EVIDENCE_PASSED`로 품질 기준을 통과했다. 이 판정은 품질 증거의 통과를 뜻하며 별도의 릴리스 승인을 대신하지 않는다.
<!-- release-version:end -->
