...
- v2.1.0 공개 뒤 GitHub Actions Node.js 22와 Windows Node.js 24 매트릭스에서 NUL 본문 왕복 테스트가 실패해 설치를 보류했습니다. v2.1.1은 그 이식성 결함만 좁게 수정한 권장 패치 릴리스입니다.
