...
- workflow SQLite v1~v3 DB를 v4로 열었을 때 기존 run, metadata, 계획 서명 키, run sequence, `plugin_update_state`와 convergence guard 이력이 유지되고 cleanup index·claim이 추가된다.
