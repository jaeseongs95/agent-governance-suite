---
name: task-contract
description: 구현·수정·마이그레이션 요청을 받아 작업을 시작하기 전, 요청이 여러 해석을 허용하거나 범위·완료 조건·권한이 불명확할 때, 긴 작업을 나눠 추적해야 할 때 쓴다. 목표·범위·수용 기준·작업 단위·위험도·권한·검증 근거를 TaskEnvelope.v1로 고정한다. 구현·실행 계획·완료 판정은 하지 않는다.
license: MIT
metadata:
  version: "1.0.0"
---
