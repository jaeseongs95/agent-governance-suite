...
const skillRoot = path.resolve(testRoot, "..", "..", "skills", "instruction-scope-resolver");
...
test("repository text files use LF line endings", async () => {
  for (const root of [skillRoot, testRoot]) {
