export const SKILL_RUNTIME_ENTRYPOINTS = Object.freeze([
  ...
  { path: "skills/recovery-strategy-selector/scripts/validate-handoff.mjs", expectedExitCode: 1, outputIncludes: '"valid":false' },
  { path: "skills/recovery-strategy-selector/scripts/validate-task-binding.mjs", expectedExitCode: 1, outputIncludes: '"valid":false' },
