...
| 구현 | [`ponytail`](https://github.com/jaeseongs95/ponytail/tree/83b2cbc3bc50df3030c49d1dfe598ccefe850a85/skills/ponytail) | 4.10.0 | 코드를 작성·수정하는 단계에서 필요 없는 기능·추상화·의존성을 만들지 않는 가장 단순한 구현을 고릅니다. |
